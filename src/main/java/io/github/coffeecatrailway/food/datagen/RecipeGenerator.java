...
//			ShapelessRecipeBuilder.shapeless(ModItems.CHEESE_SLICE.get(), 4).group("cheese_slice").requires(HNCBlocks.BLOCK_OF_CHEESE.get()).requires(ModItemTags.TOOLS_KNIFE).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_CHEESE.get()))
//					.unlockedBy("has_knife", has(ModItemTags.TOOLS_KNIFE)).save(recipeOutput);
//			ChoppingBoardRecipeBuilder.recipe(ModItems.CHEESE_SLICE.get(), 5, Ingredient.of(HNCBlocks.BLOCK_OF_CHEESE.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_CHEESE.get())).save(recipeOutput, FoodMod.id("cheese_slice_chopping_board"));
//
//			ShapelessRecipeBuilder.shapeless(ModItems.BLUE_CHEESE_SLICE.get(), 4).group("cheese_slice").requires(HNCBlocks.BLOCK_OF_BLUE_CHEESE.get()).requires(ModItemTags.TOOLS_KNIFE).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_BLUE_CHEESE.get()))
//					.unlockedBy("has_knife", has(ModItemTags.TOOLS_KNIFE)).save(recipeOutput);
//			ChoppingBoardRecipeBuilder.recipe(ModItems.BLUE_CHEESE_SLICE.get(), 5, Ingredient.of(HNCBlocks.BLOCK_OF_BLUE_CHEESE.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_BLUE_CHEESE.get())).save(recipeOutput, FoodMod.id("blue_cheese_slice_chopping_board"));
//
...
//			ShapelessRecipeBuilder.shapeless(ModItems.GOUDA_CHEESE_SLICE.get(), 4).group("cheese_slice").requires(HNCBlocks.BLOCK_OF_GOUDA_CHEESE.get()).requires(ModItemTags.TOOLS_KNIFE).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_GOUDA_CHEESE.get()))
//					.unlockedBy("has_knife", has(ModItemTags.TOOLS_KNIFE)).save(recipeOutput);
//			ChoppingBoardRecipeBuilder.recipe(ModItems.GOUDA_CHEESE_SLICE.get(), 5, Ingredient.of(HNCBlocks.BLOCK_OF_GOUDA_CHEESE.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_GOUDA_CHEESE.get())).save(recipeOutput, FoodMod.id("gouda_cheese_slice_chopping_board"));
//
//			ShapelessRecipeBuilder.shapeless(ModItems.SWISS_CHEESE_SLICE.get(), 4).group("cheese_slice").requires(HNCBlocks.BLOCK_OF_SWISS_CHEESE.get()).requires(ModItemTags.TOOLS_KNIFE).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_SWISS_CHEESE.get()))
//					.unlockedBy("has_knife", has(ModItemTags.TOOLS_KNIFE)).save(recipeOutput);
//			ChoppingBoardRecipeBuilder.recipe(ModItems.SWISS_CHEESE_SLICE.get(), 5, Ingredient.of(HNCBlocks.BLOCK_OF_SWISS_CHEESE.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_SWISS_CHEESE.get())).save(recipeOutput, FoodMod.id("swiss_cheese_slice_chopping_board"));
//
...
//					.unlockedBy("has_curdler", has(HNCItemTags.CURDLERS)).save(recipeOutput);
//			ShapelessRecipeBuilder.shapeless(ModItems.GOAT_CHEESE_SLICE.get(), 4).group("cheese_slice").requires(HNCBlocks.BLOCK_OF_GOAT_CHEESE.get()).requires(ModItemTags.TOOLS_KNIFE).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_GOAT_CHEESE.get()))
//					.unlockedBy("has_knife", has(ModItemTags.TOOLS_KNIFE)).save(recipeOutput);
//			ChoppingBoardRecipeBuilder.recipe(ModItems.GOAT_CHEESE_SLICE.get(), 5, Ingredient.of(HNCBlocks.BLOCK_OF_GOAT_CHEESE.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_cheese", has(HNCBlocks.BLOCK_OF_GOAT_CHEESE.get())).save(recipeOutput, FoodMod.id("goat_cheese_slice_chopping_board"));
...
//			ChoppingBoardRecipeBuilder.recipe(ModItems.UNBAKED_PIZZA_BASE.get(), Ingredient.of(ModItems.DOUGH.get())).tool(Ingredient.of(ModItemTags.TOOLS_ROLLING_PIN)).unlockedBy("has_dough", has(ModItems.DOUGH.get())).save(recipeOutput, FoodMod.id("unbaked_pizza_base_chopping_board"));
...
//			ChoppingBoardRecipeBuilder.recipe(ModItems.BREAD_SLICE.get(), 4, Ingredient.of(HNCItemTags.BREAD_COMMON)).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_bread", has(HNCItemTags.BREAD_COMMON)).save(recipeOutput, FoodMod.id("bread_slice_chopping_board"));
...
//			ChoppingBoardRecipeBuilder.recipe(ModItems.HAM_SLICE.get(), 4, Ingredient.of(Items.PORKCHOP)).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_porkchop", has(Items.PORKCHOP)).save(recipeOutput, FoodMod.id("ham_slice_chopping_board"));
//			ChoppingBoardRecipeBuilder.recipe(ModItems.COOKED_HAM_SLICE.get(), 4, Ingredient.of(Items.COOKED_PORKCHOP)).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_porkchop", has(Items.COOKED_PORKCHOP)).save(recipeOutput, FoodMod.id("cooked_ham_slice_chopping_board"));
...
//			ChoppingBoardRecipeBuilder.recipe(ModItems.RAW_BACON.get(), 3, Ingredient.of(ModItems.HAM_SLICE.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_ham", has(ModItems.HAM_SLICE.get())).save(recipeOutput, FoodMod.id("bacon_chopping_board"));
//			ChoppingBoardRecipeBuilder.recipe(ModItems.COOKED_BACON.get(), 3, Ingredient.of(ModItems.COOKED_HAM_SLICE.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_ham", has(ModItems.COOKED_HAM_SLICE.get())).save(recipeOutput, FoodMod.id("cooked_bacon_chopping_board"));
		...
		ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.PINEAPPLE_BITES.get(), 3).requires(ModItemTags.TOOLS_KNIFE).requires(ModItems.PINEAPPLE_RING.get()).unlockedBy("has_pineapple", has(ModItems.PINEAPPLE_RING.get()))
				.unlockedBy("has_knife", has(ModItemTags.TOOLS_KNIFE)).save(recipeOutput);
//			ChoppingBoardRecipeBuilder.recipe(ModItems.PINEAPPLE_RING.get(), 5, Ingredient.of(ModItems.PINEAPPLE.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_pineapple", has(ModItems.PINEAPPLE.get())).save(recipeOutput, FoodMod.id("pineapple_ring_chopping_board"));
//			ChoppingBoardRecipeBuilder.recipe(ModItems.PINEAPPLE_BIT.get(), 4, Ingredient.of(ModItems.PINEAPPLE_RING.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_pineapple", has(ModItems.PINEAPPLE_RING.get())).save(recipeOutput, FoodMod.id("pineapple_bit_chopping_board"));
...
//			ChoppingBoardRecipeBuilder.recipe(ModItems.TOMATO_SLICE.get(), 5, Ingredient.of(ModItems.TOMATO.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_tomato", has(ModItems.TOMATO.get())).save(recipeOutput, FoodMod.id("tomato_slice_chopping_board"));
...
//			ChoppingBoardRecipeBuilder.recipe(ModItems.CORN_KERNELS.get(), 9, Ingredient.of(ModItems.CORN_COB.get())).tool(Ingredient.of(ModItemTags.TOOLS_KNIFE)).unlockedBy("has_corn_cob", has(ModItems.CORN_COB.get())).save(recipeOutput, FoodMod.id("corn_kernels_chopping_board"));
